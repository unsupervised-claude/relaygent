...
const TYPE_EXPR = (sel, text, submit, frame) =>
  ...
  `el.scrollIntoView({block:'nearest'});el.focus();el.value=${JSON.stringify(text)};el.dispatchEvent(new Event('input',{bubbles:true}));el.dispatchEvent(new Event('change',{bubbles:true}));` +
